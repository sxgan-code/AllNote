...
//                    将每一行的行、列位置及其元素的值存入稀疏数组
                   ...
                   sparseArr[sparseCount][2] =originalArr[i][j];
                   sparseCount++;
                }
            }
        }
//        遍历稀疏数组
        ...
        for (int[] sparseItems : sparseArr) {
            for (int sparseItem : sparseItems) {
                System.out.printf("%d\t" ,sparseItem);
            }
            System.out.println();
        }
//        再将稀疏数组转换为二维数组
