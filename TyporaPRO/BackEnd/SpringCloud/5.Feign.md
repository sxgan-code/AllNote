...
Debug方式启动OrderService服务，可以看到这里的client，底层就是Apache HttpClient：
...
然后，OrderService中编写的UserClient、User、DefaultFeignConfiguration都复制到feign-api项目中

![image-20210714205221970](image/image-20210714205221970.png)



#### 2）在OrderService中使用feign-api
