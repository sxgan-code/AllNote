...
![img](image/48840BF0-992F-4CCC-A388-15CB74819D88.jpg)

左边选择 **SSH and GPG keys**，然后点击 **New SSH key** 按钮,title 设置标题，可以随便填，粘贴在你电脑上生成的 key。

![img](image/B0589847-A498-4415-8700-252BDE1B20C0.jpg)

![img](image/106AD534-A38A-47F3-88A3-B7BE3F2FEEF1.jpg)

添加成功后界面如下所示



![img](image/EC8F8872-091A-4CAB-90F2-616F34F350A9.jpg)
...
![img](image/github1.jpg)

之后在在Repository name 填入 runoob-git-test(远程仓库名) ，其他保持默认设置，点击"Create repository"按钮，就成功地创建了一个新的Git仓库：

![img](image/299CF000-7B6E-4BEC-B8C2-D9AEB053307B.jpg)

创建成功后，显示如下信息：

![img](image/1BCB4379-1A25-4C77-BB82-92B3E7185435.jpg)
...
![img](image/53CA927D-F36F-4A00-AFB2-5EAED05B535E.jpg)
...
![img](image/main-qimg-00a6b5a8ec82400657444504c4d4d1a7.png)

假设你配置好了一个远程仓库，并且你想要提取更新的数据，你可以首先执行 **git fetch [alias]** 告诉 Git 去获取它有你没有的数据，然后你可以执行 **git merge [alias]/[branch]** 以将服务器上的任何更新（假设有人这时候推送到服务器了）合并到你的当前分支。

接下来我们在 Github 上点击" README.md" 并在线修改它:

![img](image/C5A6670F-202D-4F2C-8A63-07CEA37BB67A.jpg)
...
![img](image/79A84530-7DC0-4D25-9F83-8776433A4C32.jpg)
...
![image-20211015175015044](image/image-20211015175015044.png)
...
![image-20211015175200976](image/image-20211015175200976.png)

## 3、忽略文件

有些文件你不希望上传到储存库中时，我们可以通过配置.gitignore来指定特定的文件不上传，其他协同的同事也需要配置所以需要将此文件上传。
...
在仓库文件夹下新建一个名为.gitignore的文件，并上传
